...
public class GroupAnonymousMessageSentPacket extends GroupMessageSentPacket {
    ...
    public GroupAnonymousMessageSentPacket(AssembledMessage message, long botId, IgnoredIdMessageSender sender, long responseId, long timestamp, long messageSeq, long messageId) {
    ...
    public void fireEvent(ApricotServer server, ApricotProxy proxy) {
        server.fireEvent(new GroupAnonymousMessageSentEvent(
                proxy,
                this
        ));
    }
