...
public class PrivateTemporaryMessageReceivedPacket extends PrivateMessageReceivedPacket {
    ...
    public PrivateTemporaryMessageReceivedPacket(AssembledMessage message, long botId, IgnoredIdMessageSender sender, long responseId, long timestamp, long messageSeq, long messageId) {
    ...
    public void fireEvent(ApricotServer server, ApricotProxy proxy) {
        server.fireEvent(new PrivateTemporaryMessageReceivedEvent(
                proxy,
                this
        ));
    }
