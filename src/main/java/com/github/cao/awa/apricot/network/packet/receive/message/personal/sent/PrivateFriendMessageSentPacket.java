...
public class PrivateFriendMessageSentPacket extends PrivateMessageSentPacket {
    ...
    public PrivateFriendMessageSentPacket(AssembledMessage message, long botId, IgnoredIdMessageSender sender, long targetId, long responseId, long timestamp, long messageSeq, long messageId) {
    ...
    public void fireEvent(ApricotServer server, ApricotProxy proxy) {
        server.fireEvent(new PrivateFriendMessageSentEvent(
                proxy,
                this
        ));
    }
