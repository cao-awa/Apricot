...
public abstract class GroupAnonymousMessageSentFilter extends FirewallEventHandler {
    /**
     ...
     * @author cao_awa
     */
    public abstract boolean legitimate(GroupAnonymousMessageSentEvent event);
}
