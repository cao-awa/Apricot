...
public abstract class ProxyDisconnectEventHandler extends EventHandler<ProxyDisconnectEvent> {
    /**
     ...
     * @since 1.0.0
     */
    public abstract void onDisconnect(ProxyDisconnectEvent event);
}
