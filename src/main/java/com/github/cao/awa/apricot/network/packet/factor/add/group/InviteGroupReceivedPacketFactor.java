...
public class InviteGroupReceivedPacketFactor extends PacketFactor {
    @Override
    public @NotNull InviteGroupReceivedPacket create(@NotNull ApricotServer server, @NotNull JSONObject request) {
        return new InviteGroupReceivedPacket(
