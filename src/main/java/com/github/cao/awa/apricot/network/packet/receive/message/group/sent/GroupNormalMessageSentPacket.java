...
public class GroupNormalMessageSentPacket extends GroupMessageSentPacket {
    ...
    public GroupNormalMessageSentPacket(AssembledMessage message, long botId, IgnoredIdMessageSender sender, long responseId, long timestamp, long messageSeq, long messageId) {
