package com.github.cao.awa.apricot.event.handler.firewall.filter.message.personal.received;
...
public abstract class PrivateFriendMessageReceivedFilter extends FirewallEventHandler {
     ...
     * @author cao_awa
     */
    public abstract boolean legitimate(PrivateFriendMessageReceivedEvent event);
}
