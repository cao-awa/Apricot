...
public class PrivatePokeReceivedPacket extends PokeReceivedPacket {
    ...
    public PrivatePokeReceivedPacket(long causerId, long targetId, long botId, long responseId, long timestamp) {
        this.botId = botId;
    ...
    public void fireEvent(ApricotServer server, ApricotProxy proxy) {
        server.fireEvent(new PrivatePokeReceivedEvent(
                proxy,
                this
        ));
    }
    ...
    public EventTarget target() {
        return new EventTarget(-1, this.causerId, this.botId);
    }
}
