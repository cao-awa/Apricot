package com.github.cao.awa.apricot.network.packet.receive.member.change.decrease.kick;
...
public class GroupMemberKickedPacket extends GroupMemberDecreasedPacket {
    ...
    public GroupMemberKickedPacket(long operatorId, long botId, long userId, long groupId, long timestamp) {
    ...
    public void fireEvent(ApricotServer server, ApricotProxy proxy) {
        server.fireEvent(new GroupMemberKickedEvent(
                proxy,
                this
        ));
    }
